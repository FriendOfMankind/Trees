...
const TRIPS = [
  ...
  },
  {
    ...
    emoji: "🌵", theme: "desert", status: "planned", pinned: true, page: "trips/sky-islands-2027/",
    ...
    nights: "10 nights camping", distance: "~700 mi loop", budget: "~$1,086 excl. airfare",
    tags: ["car camping", "desert", "geology", "ruins", "birding", "solo", "fly-in", "march", "reservation race"],
    why: "⚠️ Heart of Rocks and Echo Canyon are the marquee day hikes through rhyolite hoodoo forests — welded ash from the Turkey Creek caldera, so the geology is the whole point rather than a footnote. The Dragoons are the counterpoint at 1.4 billion years, and you can see one range from the other.<br><br>✅ <b>Verified Sept 2026 — the facts that decide whether March works:</b> <b>Chiricahua charges no entrance fee.</b> <b>Bonita Canyon (~5,400 ft) is year-round, 25 individual sites + 1 group, all reservable, no walk-ups, 6-month rolling window</b>, full most nights in its Feb–April peak. <b>Sunny Flat is year-round first-come — but potable water is off until April</b>, and <b>Cochise Stronghold has none at any time of year</b>: four of ten nights are haul-your-own. 🚨 <b>Rustler Park and FR 42D are closed Nov–March and unplowed</b>, so the eight miles between the monument and Portal cost 2h 35m around on I-10, and the high country is off the trip.<br><br>⚠️ <b>Turn your own rule on this before booking it.</b> \"Actively avoids crowds\" is the profile, and March is the monument's busiest month; a reservation removes the lottery, not the people. The itinerary answers that with a split — <b>3 nights in the monument, 7 outside it</b> — and puts the two hardest days on a Wednesday and a Saturday. ✅ <b>That split was re-opened and re-confirmed Sept 7 2026</b>, on the grounds that the Dragoon night is first-come and can be added any time, while the monument night cannot.",
    next: "🚨 <b>Sept 8 2026, 10:00 AM Eastern: Bonita Canyon, night of Mar 8</b> — then the same alarm on the 9th and the 10th. 25 sites, no walk-up fallback, peak month. <b>Book Gilbert Ray (Mar 5, 6, 14) tonight</b>; its whole season is already open. Airfare is Colin&rsquo;s to price",
    booking: [
      { system: "recreation.gov", what: "Bonita Canyon, Chiricahua NM (Mar 8–10)", target: "2027-03-08",
        note: "25 sites, all reservable, no first-come option, full most nights Feb–April. Releases 10:00 AM Eastern on Sept 8, 9 and 10 2026. If this fails, the middle of the trip fails." },
      { system: "pima-county", what: "Gilbert Ray CG, Tucson (Mar 5, 6 and 14)", target: "2027-03-05",
        note: "✅ Bookable NOW — the whole 2026–27 season is open. $10/night tent, reservation-only, no race. Undone rather than blocked." },
    ],
    updated: "2026-09-07",
  },
  {
