...
const TRIPS = [
     ...
     Justifies a plane ticket. */
  {
    ...
    next: "Hold the July slot but plan it last — if June and August both grow, this is what gets cut, and that is the correct outcome", updated: "2026-09-06",
  },
  {
    ...
    next: "Do not target June again without calling Shoshone NF for Island Lake and Beartooth Lake opening dates — two published sources contradict each other by five weeks, and the answer decides whether the trip exists", updated: "2026-09-06",
  },
  {
  ...
  },
  {
    ...
    emoji: "🌵", theme: "desert", status: "wishlist", pinned: false, page: null,
    start: null, dates: null, window: "Nov–Apr — ⭐ Feb, March and April are the good months, and they are also the full ones",
    region: "Southeast Arizona", country: "USA", coords: [32.0, -109.35],
    nights: "6–8 nights", budget: "Fly-in, Tucson",
    tags: ["car camping", "desert", "geology", "birding", "march", "april", "shoulder season", "reservation race"],
    why: "⚠️ Heart of Rocks and Echo Canyon are the marquee day hikes through rhyolite hoodoo forests — welded ash from the Turkey Creek caldera, so the geology is the whole point rather than a footnote. Mountain ranges rising out of desert as isolated ecological islands.<br><br>✅ <b>Verified Sept 2026 — campgrounds, which decide whether March works:</b> <b>Bonita Canyon CG (~5,400 ft) is open year-round, 23 sites, all reservable, 6-month rolling window</b>, and Feb–April is its busiest season with the campground full most nights. <b>Sunny Flat in Cave Creek is open year-round, first-come, no reservations — but potable water is off until April</b>, so an early-spring stay is a haul-your-own-water stay; Stewart is the same canyon with water off until first thaw. ⚠️ <b>Rustler Park (~8,400 ft) is closed roughly November through March</b> — FR 42D closes with the first snow and is not plowed, so the high country is off the table before April.<br><br>⚠️ Bonita Canyon Drive to Massai Point and the Echo Canyon trailhead is the paved park road and is normally open, but its winter snow status is <b>not confirmed</b> — call the monument, do not assume.<br><br>⚠️ <b>Turn your own rule on this before booking it.</b> \"Actively avoids crowds. Empty is cool if it\'s worth it\" is the profile, and March is the single most crowded month in the monument. The reservation removes the <i>lottery</i>, not the people. What defends the trip is that the crowd is concentrated in one small unit: Cave Creek Canyon on the east side, the Dragoons and Cochise Stronghold, and the Peloncillos are all far emptier in the same week. If the plan is eight days inside the monument, it fails the crowd test — if the monument is two or three days of an eight-day southeast-Arizona loop, it passes.",
    next: "23 reservable sites against a 6-month rolling window means a March 5–15 2027 trip releases Sept 5–15 2026 — that is right now, one day at a time, and it is the busiest month there.", updated: "2026-09-06",
  },
  {
