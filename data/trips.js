...
const TRIPS = [
  ...
  },
  {
    ...
    country: "USA",
    coords: [37.2, -81.4],
    nights: "10 nights — 8 reserved, 2 first-come",
    distance: "~1,600 mi round trip",
    budget: "TBD",
    tags: ["car camping", "fall color", "ruins", "BASE jumping", "first-come", "solo"],
    ...
    next: "Call 800-927-0263 — Fayette Station Road parking on Bridge Day is the one open item that changes a day",
    updated: "2026-09-04",
  },
  ...
  },
  {
    ...
    why: "📋 A paved canyon road to a glacial cirque with near-zero people. Thomas Canyon CG in Lamoille Canyon. Booked for Sept 2026 and then dropped for Colorado — still owed a visit.",
    next: "Recover the Sept 2026 booking research", updated: "2026-09-03",
  },
  {
