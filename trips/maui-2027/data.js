...
const WAYPOINTS = [
  { name: "Kahului Airport (OGG)", lat: 20.893591, lng: -156.438126, verified: true, icon: "✈️", days: "1, 8", notes: "", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  ...
  { name: "Makena Big Beach", lat: 20.631533, lng: -156.444941, verified: true, icon: "🏖️", days: "2", notes: "Dangerous shore break", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  { name: "Costco Kahului", lat: 20.886954, lng: -156.448935, verified: true, icon: "🛒", days: "2", notes: "Cheapest gas on island", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  ...
  { name: "Hāmoa Beach", lat: 20.720033, lng: -155.986632, verified: true, icon: "🏖️", days: "4", notes: "", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  { name: "Waioka Pond", lat: 20.704076, lng: -155.994829, verified: true, icon: "🤿", days: "4", notes: "Grey-area access — see notes", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  { name: "Piʻilani Hwy east end (Kīpahulu)", lat: 20.661391, lng: -156.046036, verified: true, icon: "🛣️", days: "5", notes: "Gas up in Hāna first", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  { name: "Grandma's Coffee House, Keokea", lat: 20.705486, lng: -156.356546, verified: true, icon: "☕", days: "5", notes: "", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  ...
  { name: "Komoda Store & Bakery, Makawao", lat: 20.854112, lng: -156.310647, verified: true, icon: "🥐", days: "7", notes: "Closes when sold out", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
