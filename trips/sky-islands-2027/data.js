...
window.TRIP_DATA = {
  ...
  waypoints: [
    { name: "Gilbert Ray Campground", lat: 32.220952, lng: -111.144403, verified: true, icon: "⛺", days: "1, 2, 10", notes: "Reservation-only, $10 tent, Sept 1–Apr 30. Tucson Mountain Park.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "King Canyon Trailhead", lat: 32.247182, lng: -111.167066, verified: true, icon: "🥾", days: "2", notes: "Saguaro West. Small lot, fills on weekends.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Cochise Stronghold Campground", lat: 31.928675, lng: -109.964444, verified: true, icon: "⛺", days: "3", notes: "11 sites, FCFS, $20, 5,000 ft. NO drinking water. (520) 364-3468.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Rockfellow Dome Trailhead", lat: 31.925468, lng: -109.967034, verified: true, icon: "🪨", days: "3", notes: "2.0 mi / 1,108 ft. Dragoon granite.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Slavin Gulch Trailhead", lat: 31.878774, lng: -110.026520, verified: true, icon: "⛏️", days: "4", notes: "Approach road condition unverified. Mine ruins at the turnaround.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Bonita Canyon Campground", lat: 32.012411, lng: -109.354300, verified: true, icon: "⛺", days: "4, 5, 6", notes: "~5,400 ft. All sites reservable, 6-month window, no walk-ups. Full most nights Feb–Apr.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Chiricahua NM Visitor Center", lat: 32.005586, lng: -109.356211, verified: true, icon: "ℹ️", days: "4, 6", notes: "No entrance fee. Heart of Rocks loop starts here.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Echo Canyon Trailhead", lat: 32.012037, lng: -109.315798, verified: true, icon: "🥾", days: "5", notes: "~7 mi up Bonita Canyon Drive. Smallest lot in the monument.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Massai Point", lat: 32.007220, lng: -109.312038, verified: true, icon: "👁️", days: "5", notes: "6,870 ft, end of the paved road.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Fort Bowie NHS Trailhead", lat: 32.156697, lng: -109.452546, verified: true, icon: "🏚️", days: "7", notes: "Apache Pass Road. 3 mi on foot to the fort. No overnight parking, cars only.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Sunny Flat Campground", lat: 31.885131, lng: -109.175752, verified: true, icon: "⛺", days: "7, 8, 9", notes: "~14 sites, FCFS, year-round. Potable water April–November only.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "South Fork Trailhead", lat: 31.873346, lng: -109.185056, verified: true, icon: "🐦", days: "8", notes: "Cave Creek Canyon. 4.2 mi, easy, sycamore creek walk.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Herb Martyr Trailhead", lat: 31.872569, lng: -109.234673, verified: true, icon: "🥾", days: "9", notes: "5.9 mi / 2,083 ft. Road condition unverified.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Lavender Pit, Bisbee", lat: 31.436020, lng: -109.900496, verified: true, icon: "⛏️", days: "10", notes: "Open-cut copper mine, rim viewpoint.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Tucson International Airport", lat: 32.120779, lng: -110.937358, verified: true, icon: "✈️", days: "1, 11", notes: "In and out. ~40 min from Gilbert Ray.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  ],
