...
window.TRIP_DATA = {
  ...
  waypoints: [
    { name: "Cedar Pass Campground", lat: 43.746051, lng: -101.948290, verified: true, icon: "⛺", days: "2, 3", notes: "Badlands NP. Water. No shade in the park.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Notch Trailhead", lat: 43.760258, lng: -101.928149, verified: true, icon: "🪜", days: "3", notes: "Log ladder and ledge traverse. Dawn only in July.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "West Tensleep Lake Campground", lat: 44.258406, lng: -107.215584, verified: true, icon: "⛺", days: "4, 5, 6", notes: "~9,100 ft, Bighorn NF. Cloud Peak Wilderness trailhead at camp.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Crazy Woman Canyon Road", lat: 44.187100, lng: -106.805739, verified: true, icon: "⚠️", days: "6", notes: "Unpaved, narrow, shelf sections. Clearance decision.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Island Lake Campground", lat: 44.941089, lng: -109.539231, verified: true, icon: "⛺", days: "7, 8, 9", notes: "9,518 ft, Shoshone NF. Highest camp of the trip.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Chief Joseph Scenic Byway", lat: 44.728724, lng: -109.230771, verified: true, icon: "🛣️", days: "7", notes: "WY-296. Paved. Dead Indian Pass.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Clay Butte Lookout", lat: 44.944603, lng: -109.626690, verified: true, icon: "👁️", days: "9", notes: "Fire tower. Gravel spur — assess before driving it.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Slough Creek Campground", lat: 44.948578, lng: -110.308987, verified: true, icon: "⛺", days: "10", notes: "Yellowstone. 16 sites, fills in minutes. Grizzly country.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Lamar Valley", lat: 44.868566, lng: -110.174462, verified: true, icon: "🦬", days: "10", notes: "Pull-outs only. 25 yd from bison, 100 yd from bears and wolves.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Many Glacier Campground", lat: 48.796608, lng: -113.677575, verified: true, icon: "⛺", days: "11–14", notes: "Book mid-January 2027. No walk-up fallback in July.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Iceberg Lake Trailhead", lat: 48.799409, lng: -113.677568, verified: true, icon: "🧊", days: "13", notes: "Bear corridor. Lot fills by 7 AM.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Grinnell Glacier Trailhead", lat: 48.797347, lng: -113.668127, verified: true, icon: "🏔️", days: "14", notes: "Snowfields on the upper traverse into late July.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Logan Pass", lat: 48.696605, lng: -113.718158, verified: true, icon: "🅿️", days: "15, 16", notes: "3-hour parking cap from July 1. $1 ticketed shuttle.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Apgar Campground", lat: 48.525647, lng: -113.981772, verified: true, icon: "⛺", days: "15–17", notes: "Glacier west side. First shower in fifteen days.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
    { name: "Cottonwood Campground", lat: 46.950970, lng: -103.531968, verified: true, icon: "⛺", days: "18, 19", notes: "Theodore Roosevelt NP South Unit. Wild horses and bison.", source: "Google Maps, placed via mapbench.html (Colin, Sept 2026)" },
  ],
